...
public class EmployeesServiceImpl extends ServiceImpl<EmployeesMapper, Employees> implements EmployeesService {
    ...
    public EmployeesVO getOne(Integer id) {
        ...
        EmployeesVO employeesVO = EntityUtils.toObj(getOne(wrapper), EmployeesVO::new);
    ...
    public List<EmployeesVO> getList() {
        ...
        List<EmployeesVO> employeesVos = EntityUtils.toList(employees, EmployeesVO::new);
        Set<Integer> deptIds = EntityUtils.toSet(employeesVos, EmployeesVO::getDeptId);
        if (CollUtil.isNotEmpty(deptIds)){
            ...
            Map<Integer, Dept> deptMap = EntityUtils.toMap(depts, Dept::getId, Function.identity());
    ...
    public IPage<EmployeesVO> getPage() {
        ...
        IPage<EmployeesVO> employeesVOIPage = EntityUtils.toPage(empPage, EmployeesVO::new);
        Set<Integer> deptIds = EntityUtils.toSet(employeesVOIPage.getRecords(), EmployeesVO::getDeptId);
        if (CollUtil.isNotEmpty(deptIds)){
            ...
            Map<Integer, Dept> deptMap = EntityUtils.toMap(deptList, Dept::getId, Function.identity());
